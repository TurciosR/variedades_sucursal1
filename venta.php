        ...
        <div class="ibox ">
              ...
              <div class="ibox-content">
                ...
                <div class="row focuss"><br>
                  ...
                  <div class="col-md-7"><br>
                    ...
                    echo "<a id='xc' data-toggle='modal' href='modal_ofertas.php' style='margin-right:1%;' data-target='#clienteModal' data-refresh='true' class='btn btn-sm btn-warning pull-right'><i class='fa fa-star icon-large'></i> Ofertas</a>";
          ...
          <header>
            <section>
              ...
              <div class="">
                <div class="row">
                  <div id="pago_left" class="col-md-12">
                  ...
                  <div id="pago_right" class="col-md-3" hidden>
                    <div class="wrap-table1001">
                      <div class="table100 ver1 m-b-10">
                        <div class="table100-head">
                          <table id="inventable1">
                        ...
                        <div class="table101-body">
                          <table>
                            <tbody>
                              ...
                              <tr>
                                <td class='cell100 column70 text-success'>NUM. FACTURA: </td>
                              ...
                              <tr>
                                ...
                                <td class='cell100 column30'><input type="text" id="duicli" class="txt_box2"    value="" readOnly></td>
                              </tr>
                              <tr>
...
function cargar_data()
{
  ...
  if ($count_fact > 0) {
    ...
    if ("TIK"==$alias_tipodoc) {
      ...
      $select_tipo_impresion.="<option selected value='TIK'>TICKET</option>";
    } else {
      # code...
...
function insertar()
{
  ...
  if ($cuantos>0) {
    ...
    foreach ($array as $fila) {
      ...
      //aca vamos a poner la regalia
      $array = array(
        0 => array('desde' => 30, 'hasta' => 999, 'id_producto' => 3647, 'id_presentacion' => 3630),
      );

      foreach ($array as $key => $value) {
        if(false)  //if($total>=$value['desde'] && $total<=$value['hasta'])
        {
          $sql1 = "SELECT p.id_producto,p.id_categoria, p.barcode, p.descripcion, p.estado, p.perecedero, p.exento, p.id_categoria, p.id_sucursal,SUM(su.cantidad) as stock
          FROM producto AS p
          JOIN stock_ubicacion as su ON su.id_producto=p.id_producto
          JOIN ubicacion as u ON u.id_ubicacion=su.id_ubicacion
          WHERE su.id_producto = $value[id_producto]
          AND u.bodega=0
          AND su.id_sucursal=$id_sucursal";
          $stock1=_query($sql1);
          $nrow1=_num_rows($stock1);
...
function imprimir_fact()
{
  ...
  if ($tipo_impresion=='TIK') {
    ...
    $footers="GRACIAS POR SU COMPRA, VUELVA PRONTO......"."|"."REVISE SU MERCADERIA"."|"."NO SE ACEPTAN CAMBIOS NI DEVOLUCIONES";
  }
...
function insertar_preventa()
{
  ...
  if ($id_factura==0) {
    ...
    if (_num_rows($sql_num) > 0) {
      ...
      // code...
      $noduplicate=false;
      $errordu = ": Esta preventa ya habia sido finalizada";
      $id_factura=0;
      $hoy = date("Y-m-d");
      $sql="SELECT MAX(numero_ref) as ref FROM factura WHERE id_sucursal='$id_sucursal' AND fecha='$hoy'";
      $result= _query($sql);
  ...
  if ($cuantos>0) {
    ...
    if ($a&&$b&&$c&&$noduplicate) {
      ...
      _rollback(); // transaction rolls back
      $xdatos['typeinfo']='Error';
      $xdatos['msg']='Registro no pudo ser ingresado!'.$errordu;
    }
  }
  echo json_encode($xdatos);
}
