                      ...
                      <table class="table table-striped table-bordered table-condensed" id="inventable">
                        <thead>
                          <tr>
                            ...
                            <th style="display:none" class="col-lg-1">Prec. C</th>
                        ...
                        <tbody>
                          ...
                          while ($row=_fetch_array($sql_det)) {
                            ...
                            <td style="display:none"><div class=''> <?php echo $unit ?> <input type='text' readonly class='form-control precio_compra' value='<?php echo $row['costo'] ?> ' style='width:80px;'></div></td>
                            ...
                            <td><div class=''><input type='text' readonly   class='form-control cant' style='width:60px;' value='<?php echo intdiv($row['cantidad'],$row['unidad']) ?>'></div></td>
                        ...
                        <tfoot>
                          <tr>
                            ...
                            <td colspan=3>Total Producto</td>
                            <td id='totcant'>0</td>
                            <td></td>
                          </tr>
                        </tfoot>
...
function insertar()
{
  ...
  $form_data = array(
    ...
    'empleado_recibe' => $_SESSION['nombre'],
  );
  ...
  for ($i=0;$i<$cuantos ;$i++)
  {
    ...
    $sql_get_p=_fetch_array(_query("SELECT presentacion_producto.id_server,producto.id_server as id_server_prod FROM presentacion_producto JOIN producto ON presentacion_producto.id_producto=producto.id_producto WHERE id_pp=$id_presentacion"));
