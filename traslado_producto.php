...
tbody {
  ...
  <style media="screen">
    #inventable1 tr th:nth-child(4)
    {
      display:none;
    }

    #loadtable tr td:nth-child(4)
    {
      display:none;
    }
  </style>
          ...
          <?php if ($links!='NOT' || $admin=='1') { ?>
            <div class="ibox-content">
              ...
              <div class="row" id='buscador'>
                ...
                <div class="col-lg-2" >
                  <div class='form-group has-info' hidden><label>Nº de vale</label>

                    <input type="text" class="form-control" id="numero_vale" name="numero_vale" value="<?php if ($id_traslado!=0){ echo $rowtg['n_vale'];}else{ echo uniqid(); } ?>">
                  </div>
                </div>
                <div class="col-lg-6">
