...
function guardar_preventa() {
  ...
  var items = $("#items").val();
  var msg = "";
  var numero_factura_impresa = $("#numero_factura_impresa").val();
  //IMPUESTOS
  error = false;
  ...
  dataString += '&id_factura=' + id_factura + "&numero_factura_impresa="+ numero_factura_impresa;
