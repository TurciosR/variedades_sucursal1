...
$(document).on('change', '#origen', function(event) {
  ...
  id_origen = $(this).val();
  $.ajax({
    url: 'editar_pedido_app.php',
    type: 'POST',
    dataType: 'json',
    data: {process: 'change_font',id_pedido:id_pedido,id_origen:id_origen},
    success: function(xdatos)
    {
      location.href = 'editar_pedido_app.php?id_pedido='+id_pedido;
    }
  })
  ...
  $.ajax({
    ...
    success: function(data)
        ...
        filas++;
	      ...
	      tr_add += "<td class='cell100 column20 text-success'>"+descrip_only+exento+'</td>';
    ...
    $.ajax({
      ...
      success: function(datax) {
        ...
        if(datax.typeinfo == "Success")
        {
          setTimeout(
            function() {
              location.href = "admin_pedido_app.php"
