...
function initial()
{
  ...
  $sql_cot = _query("SELECT * FROM pedido_app WHERE id_pedido='$id_cotizacion' and finalizada=0");
        ...
        <div class="col-lg-12">
          <div class="ibox">
            <?php  if ($links!='NOT' || $admin=='1') { ?>
                      ...
                      <div class="row">
                        ...
                        <div class='col-lg-2'>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-5">
                              <label>Boton para efectuar el pedido</label>
                              <button type="submit" style='width:100%'  id="editari" name="editari" class="btn btn-warning pull-right"><i class="fa fa-save"></i> Guardar Pedido</button>
                            </div>
                            <div class="col-md-1">
                              <label>Salir</label>
                              <a class="btn btn-danger pull-right" style='width:100%'  href="dashboard.php" id='salir'><i class="fa fa-mail-reply"></i> Salir</a>
                            </div>
                          </div><br>
                        </div>
                                  ...
                                  <table id="inventable1">
                                    <thead>
                                      <tr class="row100 head">
                                        ...
                                        <th class='success  cell100 column10'>Pedido</th>
                                ...
                                <div class="table100-body js-pscroll">
                                  <table>
                                    <tbody id="mostrardatos">
                                      <?php
                                      $sql = _query("SELECT p.id_categoria, p.id_producto, p.descripcion, cd.precio_venta, cd.cantidad, cd.id_presentacion, cd.subtotal,cd.unidad FROM pedido_detalle_app as cd JOIN producto as p ON cd.id_prod_serv=p.id_producto WHERE id_pedido='$id_cotizacion'");
                                      $filas = 0;
                                      while ($row = _fetch_array($sql))
                                      {
                                        ...
                                        $sql_aux_a = _query("SELECT presentacion.nombre, presentacion_producto.descripcion,presentacion_producto.id_pp as id_presentacion,presentacion_producto.unidad, presentacion_producto.precio
                                          ...
                                          $pedido= "<td class='cell100 column10 text-success'><div class='col-xs-2'>".round($cantidad/$up,0)."</div></td>";
                                          $cantidades = "<td class='cell100 column10 text-success'><div class='col-xs-2'><input type='text'  class='txt_box decimal2 ".$id_categoria." cant' id='cant' name='cant' value='"."' style='width:60px;'></div></td>";
                                          ...
                                          $tr_add .= "<td class='cell100 column20 text-success'>".$descripcion." ".$exent2."</td>";
              ...
              echo "<script src='js/funciones/pedido_app.js?id=".rand(0,9999)."'></script>";
            } //permiso del script
            else
            {
              ...
              function editar()
              {
                ...
                $datped = _fetch_array(_query("SELECT * FROM pedido_app where id_pedido=$id_pedido"));
                ...
                $insertarM = _insert_s($table,$form_data);
                ...
                if ($nrow1>0)
                {
                  ...
                  function getpresentacion()
                  {
                    ...
                    function change_font()
                    {
                      ...
                      $where_clause = 'id_pedido = '.$_REQUEST['id_pedido'];
